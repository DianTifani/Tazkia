	...
	if(isset($_GET['data'])){
		$kode_adm = $_GET['data'];
		$_SESSION['kode_adm']=$kode_adm;
		
	  //get data adm
		$sql_d = "select `adm` from `adm` where `kode_adm` = '$kode_adm'";
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3><i class="fas fa-edit"></i> Edit Administrasi</h3>
          </div>
          <div class="col-sm-6">
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"style="margin-top:5px;"><i class="far fa-list-alt"></i> Form Edit Administrasi</h3>
      ...
      <form class="form-horizontal"action="index.php?include=konfirmasi_edit_adm" method="post">
        <div class="card-body">
          <div class="form-group row">
            <label for="adm" class="col-sm-3 col-form-label">Administrasi</label>
            <div class="col-sm-7">
              <input type="text" class="form-control" id="adm" name="adm" value="<?php echo $adm;?>">
            </div>
          </div>
        </div>
        <!-- /.card-body -->
